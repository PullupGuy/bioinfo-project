...
1. **Parsing:** Extraction of contig length,
circularity, and coverage data from headers. 
2. **Quality Assessment:**
Classification of Metagenome-Assembled Genomes (MAGs) based on
completeness and contamination. 
3. **Visualization:** Comparison of
...
sns.boxplot(
    ...
    hue="assembler",
    legend=False,
    whis=75)    #adjusted whiskers length
...
The relationship between contig length and sequencing
...
![](report_files/figure-commonmark/fig-quality-output-1.png)

Figure 5: Quality of Large Circular Contigs (\>500kb).
...
if len(large_circ) > 0:
    ...
    plt.ylabel("Phylum")
    plt.tight_layout()
    plt.subplots_adjust(left=0.18, right=0.92)  #adjusting for long labels
    plt.show()
else:
    print("No large circular contigs found.")
```
...
![](report_files/figure-commonmark/fig-taxonomy-output-1.png)

Figure 6: Phylum-level classification of large circular contigs.
